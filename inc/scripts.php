...
if ( ! function_exists( 'wpex_enqueue_js_in_footer' ) ) {
    function wpex_enqueue_js_in_footer() {
        ...
        wp_enqueue_script( 'wp-global', $dir . '/js/wp-global.js', ['jquery'], '1.0', true );
    }
    add_action('wp_footer', 'wpex_enqueue_js_in_footer');
}

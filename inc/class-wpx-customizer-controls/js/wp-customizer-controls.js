(function ($) {
  $(function () {
      ...
      $.fn.wpxSizeControl = function() {
        const control = $(this);
        const id = control.attr("id");
        const fixedSize = $("#" + id + "_fixed_size");
        const useFixedSize = $("#" + id + "_use_fixed_size");
        ...
        useFixedSize.on("change", function () {
          fixedSize.prop("disabled", !toBoolean(useFixedSize));
          updateHiddenField();
        });

        fixedSize.on("input", function () {
          updateHiddenField();
        });

...
if ($post_formats && is_array($post_formats[0])) {
    ...
    <div class="u-margin-top-10 u-grid u-grid-col-s u-flex-gap-10 u-tt-all-uppercase ufc_search">
        <a href="<?php echo esc_url($all_link_url); ?>" class="u-link-button u-block-100 u-flex u-flex-row u-flex-nowrap u-ai-c u-jc-sb<?php echo universal_search_filter_item_class('all'); ?>" role="button" tabindex="0">
        ...
        foreach ($post_formats[0] as $post_format) {
            ...
            <a href="<?php echo esc_url($post_format_url); ?>" class="u-link-button u-block-100 u-flex u-flex-row u-flex-nowrap u-ai-c u-jc-sb<?php echo universal_search_filter_item_class($post_format_slug); ?>" role="button" tabindex="0">
